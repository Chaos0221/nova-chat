...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-full items-center justify-center overflow-hidden">
      ...
      <div className="relative w-full max-w-sm space-y-8 px-6 animate-in fade-in-0 zoom-in-95 duration-700">
        <div className="text-center space-y-3">
          <div className="inline-flex items-center justify-center mb-2">
            <div className="relative">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary/20 to-primary/5 shadow-xl shadow-primary/10">
          ...
          <h1 className="text-3xl font-semibold tracking-tight">Nova Chat</h1>
